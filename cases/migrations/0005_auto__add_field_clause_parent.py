...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Clause.parent'
        db.add_column('cases_clause', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cases.Clause'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Clause.parent'
        db.delete_column('cases_clause', 'parent_id')
