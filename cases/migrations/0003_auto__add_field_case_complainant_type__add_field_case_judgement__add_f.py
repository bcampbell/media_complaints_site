...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Case.complainant_type'
        db.add_column('cases_case', 'complainant_type', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Case.judgement'
        db.add_column('cases_case', 'judgement', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)

        # Adding field 'Case.offending_page'
        db.add_column('cases_case', 'offending_page', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Case.correction_page'
        db.add_column('cases_case', 'correction_page', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Case.correction_date'
        db.add_column('cases_case', 'correction_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Changing field 'Case.legacy_id'
        db.alter_column('cases_case', 'legacy_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Case.complainant_type'
        db.delete_column('cases_case', 'complainant_type')

        # Deleting field 'Case.judgement'
        db.delete_column('cases_case', 'judgement')

        # Deleting field 'Case.offending_page'
        db.delete_column('cases_case', 'offending_page')

        # Deleting field 'Case.correction_page'
        db.delete_column('cases_case', 'correction_page')

        # Deleting field 'Case.correction_date'
        db.delete_column('cases_case', 'correction_date')

        # Changing field 'Case.legacy_id'
        db.alter_column('cases_case', 'legacy_id', self.gf('django.db.models.fields.CharField')(max_length=256))
