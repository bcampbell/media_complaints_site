...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Case.offending_date'
        db.add_column('cases_case', 'offending_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Case.offending_date'
        db.delete_column('cases_case', 'offending_date')
