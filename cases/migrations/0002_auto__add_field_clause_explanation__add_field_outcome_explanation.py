...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Clause.explanation'
        db.add_column('cases_clause', 'explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Outcome.explanation'
        db.add_column('cases_outcome', 'explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Clause.explanation'
        db.delete_column('cases_clause', 'explanation')

        # Deleting field 'Outcome.explanation'
        db.delete_column('cases_outcome', 'explanation')
